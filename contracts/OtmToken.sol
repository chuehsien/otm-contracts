...
contract OtmToken is LiquidityToken {
     ...
     * @param _investorAddress address for minting OTM tokens
        ...
        external
    {
        ...
        criticalMass[_referrer].activationDay = _nextOtmDay();
    }

    /**
     * @notice allows to create stake directly with ETH
     * if you don't have OTM tokens method will convert
     ...
     * @param _tokenAmount amount to be converted to OTM
     * @param _lockDays amount of days it is locked for.
     * @param _referrer referrer address for +10% bonus
     */
