...
abstract contract LiquidityToken is StakingToken {
     ...
     * @param _liquidityTokens amount of UNI-OTM staked.
     */
        ...
        returns (bytes16 liquidityStakeID)
    {
        require(
            ...
            // OTM: LiquidityGuard is not active
        );
        ...
        newLiquidityStake.startDay = _nextOtmDay();
        ...
        returns (uint256)
    {
        ...
        liquidityStake.closeDay = _currentOtmDay();
        ...
        returns (uint256 _rewardAmount)
    {
        ...
        uint256 calculationDay =
            globals.currentOtmDay < maxCalculationDay ?
            globals.currentOtmDay : maxCalculationDay;
