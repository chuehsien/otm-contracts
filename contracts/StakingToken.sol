...
abstract contract StakingToken is ReferralToken {
     ...
     * @param _stakedAmount amount of OTM staked.
    ...
    */
        ...
        )
    {
        require(
            ...
            // 'OTM: not an active stake'
        );

        _stake = stakes[_staker][_stakeID];
        _stake.closeDay = _currentOtmDay();
    ...
    */
    ...
    function _sharePriceUpdate(
        ...
        private
    {
        if (_stakeShares > 0 && _currentOtmDay() > FORMULA_DAY) {
